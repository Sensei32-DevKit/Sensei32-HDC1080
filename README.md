...
Sensei32 can be used with most third-party library designed for Arduino. In this example, the Texas Instruments HDC1080 Temperature and Humidity sensor is read using a stantad library, that can be easily downloaded from the Arduino Library Manager:
